...
public class UpdateBiodata1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_biodata1);
        ...
        cursor = sqLiteDatabase.rawQuery("SELECT * FROM biodata_diri_khusus WHERE nama = '" +
        ...
        fabUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                sqLiteDatabase.execSQL("update biodata_diri_khusus set nama='" +
                        text2.getText().toString() + "', noktp='" +
                        text3.getText().toString() + "', jk='" +
                        text4.getText().toString() + "', tujuan='" +
